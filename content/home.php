    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            ...
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Here at Flowbite we
                ...
                economic growth.</p>
            <a href="pdf/srs.pdf" target="_blank"
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
            ...
            <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/ali.jpg" alt="Bonnie Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Ali Polanunu</a>
                    </h3>
                    <p>Group Leader / FS Developer</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
                            <a href="#" class="text-blue-800 hover:text-gray-900 dark:hover:text-white">
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/joo.jpg" alt="Helene Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Grihfit Joiner</a>
                    </h3>
                    <p>Member</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/dede.jpg" alt="Jese Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Tri Astuti</a>
                    </h3>
                    <p>Member</p>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/intan.jpg" alt="Joseph Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Intan Kaimudin</a>
                    </h3>
                    <p>Member</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/intan.jpg" alt="Sofia Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Danny Firmansyah</a>
                    </h3>
                    <p>Member</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/alin.jpg" alt="Leslie Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Alincindra Payapo</a>
                    </h3>
                    <p>Member</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
                ...
                <div class="text-center text-gray-500 dark:text-gray-400">
                    <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="img/devi.jpg" alt="Michael Avatar">
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Devi Triani</a>
                    </h3>
                    <p>Member</p>
                    <ul class="flex justify-center mt-4 space-x-4">
                        <li>
