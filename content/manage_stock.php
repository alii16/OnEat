...
// Ambil dan tampilkan item untuk restoran
$stmt = $pdo->prepare('SELECT * FROM menu_items WHERE restaurant_id = ?');
$stmt->execute([$restaurant_id]);
$items = $stmt->fetchAll();
?>

<div class="bg-gray-50 dark:bg-gray-900 min-h-screen bg-gray-100 flex justify-center">
    <div class="container mx-auto max-w-screen-xl px-4 py-6">
        <div class="text-center">
            <h1 class="text-gray-900 dark:text-white text-3xl font-bold text-gray-900 mb-6 mt-8">Manage Stock</h1>
        </div>
            ...
            <?php foreach ($items as $item): ?>
                ...
                <div
                    ...
                    <div class="h-56 w-full">
                        <a href="index.php?page=quick_view_resto&id=<?= $item['id'] ?>">
                    ...
                    <div class="pt-6">
                        ...
                        <div class="mt-4 flex items-center justify-between gap-4">
                            <a href="index.php?page=edit_item&id=<?= htmlspecialchars($item['id']) ?>"
                                class="inline-flex items-center rounded-lg bg-yellow-400 px-4 py-2.5 sm:px-2 text-sm font-medium text-white hover:bg-yellow-600 focus:outline-none focus:ring-4  focus:ring-yellow-300 dark:bg-yellow-400 dark:hover:bg-yellow-500 dark:focus:ring-yellow-600">
                            ...
                            <form method="post" onsubmit="return confirmDelete()">
                                ...
                                <button type="submit"
                                    class="inline-flex items-center rounded-lg bg-red-600 px-4 py-2.5 sm:px-2 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4  focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                    <svg class="-ms-2 me-2 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"
        ...
        <div class="flex items-center justify-center">
            <a href="index.php?page=add_item"
                ...
                <svg class="w-6 h-6 me-2 text-white text-gray-800 dark:text-white" aria-hidden="true"
